...
//!
//! Introduced in Stage 2 and grown through later stages as durability,
//! recovery, and compaction add new failure modes. The public API surfaces
//! these variants so callers never have to know about memtables, WALs, or
//! SSTables.
...
pub enum Error {
    ...
    ValueTooLarge,
    /// Background compaction recorded a failure.
    Compaction(String),
}
...
impl fmt::Display for Error {
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        match self {
            ...
            Error::Compaction(message) => write!(f, "compaction error: {message}"),
        }
    }
}
...
impl PartialEq for Error {
    fn eq(&self, other: &Self) -> bool {
        match (self, other) {
            ...
            | (Error::CorruptedRecord, Error::CorruptedRecord)
            ...
            (Error::Compaction(a), Error::Compaction(b)) => a == b,
